...
function createDocument(obj: any) {
...
function sendEmail(doc: any, obj: any) {
  GmailApp.sendEmail(
    `${obj.email}`,
    'lucky winner???',
...
function getAlldata(suraPrize: any) {
  ...
  const transform = (value: any) =>
    value.reduce((acc: any, cur: any, i: any) => {
      acc[headers[i]] = cur;
      return acc;
    }, {});
...
// create google map
function createMap(obj: any, prize: any) {
